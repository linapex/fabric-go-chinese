...
//Go 1.9将GoPath设置为$Home/Go（如果未设置GoPath）
...
path := "http://github.com/hyperledger/fabric/examples/chaincode/go/map“链接
...
{path: "http://github.com/hyperledger/fabric/examples/chaincode/go/map“，成功：真，
{path: "https://github.com/hyperledger/fabric/examples/chaincode/go/map“，成功：真，
...
//testgetldflagsopts测试chaincode.golang.dynamicclink的处理
...
//testgeneratedockerbuild执行docker build所需的功能
...
{gopath: defaultGopath, spec: spec{CCName: "invalidhttp", Path: "https://not/a/valid/path“，成功表达式：false，realgen:true，
