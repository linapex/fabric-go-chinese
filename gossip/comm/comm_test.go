...
func TestConnectUnexpectedPeer(t *testing.T) {
	t.Parallel()
//场景：在这两种场景中，COMM1连接到COMM2或COMM3。
//希望看到一个pki-id，它等于comm4的pki-id。
//连接尝试将根据comm2或comm3成功或失败
//与comm4在同一组织中
	comm1Port := 1548
	comm2Port := 1549
	comm3Port := 1550
