...
//filteredTransaction是有关事务的最小信息集
//块内
...
//filteredTransactionActions是TransactionAction数组的包装器
//来自常规块的消息
...
//filteredchaincodeaction是有关操作的最小信息集
//在交易中
...
//Deliver First需要AB类型的信封。使用
//作为已封送的医嘱者的有效负载数据。seekinfo消息，
//然后接收一系列的块回复
