...
//chaincodequeryresponse返回与之相关的每个chaincode的信息
//到lscc.go中的查询，如getchaincodes（返回所有链码
//在通道上实例化）和getInstalledChaincodes（返回所有链码
//安装在对等机上）
...
//实例化时的chaincode函数及其参数。这将是
//如果查询返回有关已安装链码的信息，则为空。
...
//channelqueryresponse返回与之相关的每个通道的信息
//到lscc.go中的查询，如getchannels（返回
//给定对等体
