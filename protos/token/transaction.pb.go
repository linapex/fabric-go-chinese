...
//tokenTransaction控制payload.data的结构，当
//事务的信封头指示类型为的事务
//“令牌”
...
//plainTransferFrom指定将一个或多个明文委托令牌传输到一个或多个输出
//到委托输出
